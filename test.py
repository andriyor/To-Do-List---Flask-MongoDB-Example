...
def lists():
    ...
    todos_l = todos.find()
    a1 = "active"
    return render_template('index.html', a1=a1, todos=todos_l)
...
def completed():
    ...
    a3 = "active"
    return render_template('index.html', a3=a3, todos=todos_l)
...
def search():
    ...
    return render_template('searchlist.html', todos=todos_l)
